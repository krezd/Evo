    ...
    public Weather getLocForWeather(String location) throws Exception {
        ...
        if (searchedLocation == null) {
            ...
            if (response != null && !response.isEmpty()) {
                ...
                return loadBalancedRestTemplate.getForObject("http://"+weatherUrl+"/weather?lat=" + loc.getLatitude() + "&lon=" + loc.getLongitude(), Weather.class);
            } else {
                throw new Exception("Location not found");
            }
        }
        return loadBalancedRestTemplate.getForObject("http://"+weatherUrl+"/weather?lat=" +searchedLocation.getLatitude() + "&lon=" + searchedLocation.getLongitude(), Weather.class);
    }

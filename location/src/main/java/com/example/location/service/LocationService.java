    ...
    public Weather getLocForWeather(String location) throws Exception {
        ...
        if (searchedLocation == null) {
            ...
            if (response != null && !response.isEmpty()) {
                ...
                return restTemplate.getForObject("http://localhost:8087/weather?lat=" + loc.getLatitude() + "&lon=" + loc.getLongitude(), Weather.class);
            } else {
                throw new Exception("Location not found");
            }
        }
        return restTemplate.getForObject("http://localhost:8087/weather?lat=" +searchedLocation.getLatitude() + "&lon=" + searchedLocation.getLongitude(), Weather.class);
    }
